...
const uiSlice = createSlice({
  name: "ui",
  initialState: { darkMode: false, showBanner: false }, // Banner starts hidden
  reducers: {
  ...
  return (
    <View style={[styles.container, isTablet && styles.containerTablet]}>
      ...
      {showBanner && (
        ...
        >
          Task added! You can manage your tasks below.
        </Banner>
      )}
...
/********************
 * TodosCard component - shows todos where done = false
 ********************/
...
function TodosCard() {
  ...
  const addTask = () => {
    ...
    dispatch(showBanner()); // Show banner each time a task is added
    setTitle("");
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <Card style={{ flex: 1, marginRight: numColumns > 1 ? 8 : 0 }}>
              ...
              />
              <Card.Actions>
                <Button onPress={() => dispatch(toggleTodo(item.id))} textColor="#4caf50">Done</Button>
...
/********************
 * DoneCard component - shows todos where done = true
 ********************/
